...
_BUILTIN_TOOL_METAS: list[ToolMeta] = [
    ...
    ToolMeta.safe_default("glob_search", is_read_only=True, is_concurrency_safe=True, tool_group="file",
                          search_hint="find files matching a glob pattern"),
    ToolMeta.safe_default("grep_search", is_read_only=True, is_concurrency_safe=True, tool_group="file",
    ...
    ToolMeta.safe_default("get_system_info", is_read_only=True, is_concurrency_safe=True, should_defer=True, tool_group="shell",
                          search_hint="get operating system information"),
    ToolMeta.safe_default("list_environment_variables", is_read_only=True, is_concurrency_safe=True, should_defer=True, tool_group="shell",
    ...
    ToolMeta.safe_default("git_log", is_read_only=True, is_concurrency_safe=True, tool_group="git",
                          search_hint="show commit history log"),
    ToolMeta.safe_default("git_branch", is_read_only=True, is_concurrency_safe=True, tool_group="git",
    ...
    ToolMeta.safe_default("list_project_files", is_read_only=True, is_concurrency_safe=True, should_defer=True, tool_group="project",
                          search_hint="list files in the project"),
    ToolMeta.safe_default("get_file_info", is_read_only=True, is_concurrency_safe=True, should_defer=True, tool_group="project",
                          search_hint="get detailed information about a file"),
    ToolMeta.safe_default("list_symbols", is_read_only=True, is_concurrency_safe=True, should_defer=True, tool_group="project",
