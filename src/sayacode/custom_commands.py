"""Discover and expand user-authored Markdown slash commands."""
...
def discover_custom_commands(
    ...
    *,
    ...
    """Return project commands ahead of user commands on name collisions."""
...
def expand_custom_command(
    ...
    """Expand $ARGUMENTS and positional $1…$N without executing Markdown."""
